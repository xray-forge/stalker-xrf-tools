...
impl OgfJointIkData {
  pub fn read_versioned<T: ByteOrder>(reader: &mut ChunkReader, version: u16) -> XRayResult<Self> {
    Ok(Self {
  ...
  pub fn write_versioned<T: ByteOrder>(&self, writer: &mut ChunkWriter) -> XRayResult {
