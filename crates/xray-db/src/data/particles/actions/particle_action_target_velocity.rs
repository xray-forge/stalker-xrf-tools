...
mod tests {
  ...
  fn test_read_write() -> XRayResult {
    ...
    assert_eq!(
      ParticleActionTargetVelocity::read::<XRayByteOrder>(&mut reader)?,
      original
    );
  ...
  fn test_import_export() -> XRayResult {
    ...
    assert_eq!(
      ParticleActionTargetVelocity::import("data", &source)?,
      original
    );
  ...
  fn test_serialize_deserialize() -> XRayResult {
    ...
    assert_eq!(
      original,
      serde_json::from_str::<ParticleActionTargetVelocity>(&serialized).unwrap()
    );
