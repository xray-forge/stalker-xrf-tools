...
pub fn read_u16_chunk<T: ByteOrder>(reader: &mut ChunkReader) -> io::Result<u16> {
...
pub fn read_u32_chunk<T: ByteOrder>(reader: &mut ChunkReader) -> io::Result<u32> {
...
pub fn read_f32_chunk<T: ByteOrder>(reader: &mut ChunkReader) -> io::Result<f32> {
...
pub fn read_f32_vector_chunk<T: ByteOrder>(reader: &mut ChunkReader) -> io::Result<Vector3d> {
...
pub fn read_till_end_binary_chunk(reader: &mut ChunkReader) -> io::Result<Vec<u8>> {
...
pub fn read_null_terminated_win_string_chunk(reader: &mut ChunkReader) -> io::Result<String> {
