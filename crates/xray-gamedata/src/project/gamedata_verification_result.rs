...
impl GamedataVerificationResult {
  ...
  pub fn get_failure_messages(&self) -> Vec<String> {
    vec![
      Self::get_result_failure_message(&self.animations_result),
      Self::get_result_failure_message(&self.format_result),
      Self::get_result_failure_message(&self.levels_result),
      Self::get_result_failure_message(&self.meshes_result),
      Self::get_result_failure_message(&self.resources_result),
      Self::get_result_failure_message(&self.schemes_result),
      Self::get_result_failure_message(&self.shaders_result),
      Self::get_result_failure_message(&self.sounds_result),
      Self::get_result_failure_message(&self.spawns_result),
      Self::get_result_failure_message(&self.textures_result),
      Self::get_result_failure_message(&self.weapons_result),
      Self::get_result_failure_message(&self.weathers_result),
    ]
    .into_iter()
    .flatten()
    .collect()
  ...
  fn get_result_failure_message<T>(result: &GamedataResult<T>) -> Option<String>
  where
    T: GamedataGenericVerificationResult,
  {
    match result {
      ...
      Err(error) => Some(format!("Check failed: {error}")),
    }
  }
}
