...
const TESTS_CASES: &[(
  ...
  (
    ...
    &[(
      ...
      0x0000,
      0x00000000,
      "2012-04-05 21:10:20 UTC",
      1,
      OsType::Unix,
      CompressionMethod::Lh1,
    )],
  ),
  (
    "dir.lzh",
    &[(
      ...
      0x0000,
      0x00000000,
      "2012-04-06 13:08:30 UTC",
      1,
      OsType::Unix,
      CompressionMethod::Lhd,
    )],
  ),
  (
    "unixsep.lzh",
