...
pub fn create_initialize_translations_command() -> Command {
  Command::new("initialize-translations")
...
pub fn initialize_translations(matches: &ArgMatches) -> Result<(), TranslationError> {
