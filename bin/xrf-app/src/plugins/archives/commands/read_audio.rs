...
#[cfg_attr(feature = "typescript-bindings", specta::specta(rename = "read_audio"))]
#[tauri::command(rename = "read_audio")]
pub async fn archives_read_audio(
  path: &str,
  state: State<'_, ArchiveProjectState>,
) -> TauriResult<ArchiveAudioPreview> {
