...
export const commands = {
  ...
  getSpawnFileGraphs: () =>
    __TAURI_INVOKE<{
      ...
      edges: GraphEdge[];
      points: GraphLevelPoint[];
      crossTables: GraphCrossTable[];
...
export type AlifeObjectCreature = {
  ...
  group: number;
  health: number | null;
  dynamicOutRestrictions: number[];
  dynamicInRestrictions: number[];
  killerId: number;
...
export type AlifeSmartCover = {
  ...
  loopholes: AlifeSmartCoverLoophole[];
};
