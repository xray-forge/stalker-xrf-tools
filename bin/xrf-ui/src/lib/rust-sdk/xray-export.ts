 ...
 */
export type ExportDescriptor = { name: string; description: string | null; source: ExportSourceDescriptor } & (
  | { kind: "callable"; parameters: Array<ExportParameterDescriptor>; returns: ExportReturnDescriptor }
  | { kind: "value"; typing: string }
);
 ...
 */
export type ExportReturnDescriptor = { typing: string; description: string | null };

/**
 * The source text that declares one extern.
 */
export type ExportSourceContent = { name: string; path: string; line: number; endLine: number; content: string };
 ...
 */
export type ExportsProject = { root: string; declarations: Array<ExportDescriptor> };
