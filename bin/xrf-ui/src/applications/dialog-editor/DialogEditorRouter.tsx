...
import { DialogEditorPage } from "@/applications/dialog-editor/pages/DialogEditorPage";
import { DialogEditorTestPage } from "@/applications/dialog-editor/pages/DialogEditorTestPage";
