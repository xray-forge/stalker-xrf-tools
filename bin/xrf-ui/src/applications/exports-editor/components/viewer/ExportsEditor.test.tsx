...
describe("opened exports editor", () => {
  ...
  function renderEditor() {
    return renderWithProviders(
      ...
      { route: "/exports-editor/exports", bindings: [ProjectService, ExportsService] }
    );
  }
  ...
  it("closes successfully before navigating home", async () => {
    const { findByLabelText, findByText } = renderWithProviders(
      <Routes>
        <Route path={"/exports-editor/exports"} element={<ExportsEditorPage />} />
        <Route path={"/exports-editor"} element={<div>Exports tools</div>} />
      </Routes>,
      { route: "/exports-editor/exports", bindings: [ProjectService, ExportsService] }
    );
    ...
    expect(await findByText("Exports tools")).toBeInTheDocument();
    await waitFor(() => {
  ...
  it("stays open and reports a close failure", async () => {
    ...
    expect(getByText("Exports editor")).toBeInTheDocument();
...
describe("empty exports editor", () => {
  it("keeps an empty project open", async () => {
    ...
    const { findAllByText, findByText } = renderWithProviders(<ExportsEditorPage />, {
      route: "/exports-editor/exports",
