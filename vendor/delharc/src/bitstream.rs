...
impl<R: Read> BitStream<R> {
  ...
  fn next_bits(&mut self, n: u32) -> LhaResult<BitBuf, R> {
    ...
    let bits_read = 8u32 * self.inner.read_all(&mut buf).map_err(LhaError::Io)? as u32;
    ...
    let res = res & (res - 1) | new_bits >> (BITBUF_BITSIZE - missing_bits);
...
mod tests {
  ...
  fn bit_stream_works() {
    ...
    let mut somebits: &[u8] = &[
      0b01001100, 0b01110000, 0b11110000, 0b01111100, 0b00001111, 0b11000000, 0b01111111, 0b00000000, 0b11111111,
      0b00000000, 0b01111111, 0b11000000, 0b00001111, 0b11111100, 0b00000000, 0b01111111, 0b11110000, 0b00000000,
      0b11111111, 0b11110000, 0b00000000, 0b01111111, 0b11111100, 0b00000000, 0b00001111, 0b11111111, 0b11000000,
